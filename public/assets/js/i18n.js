...
const translations = {
    en: {
        ...
        "f.searchListings": "Search listings",
        "f.searchExample": "e.g. generator, drill, tent",
        "f.type": "Type",
        "f.distance": "Distance",
        "f.km1": "Up to 1 km",
        "f.km3": "Up to 3 km",
    ...
    uk: {
        ...
        "product.perMonth": "за місяць",
        "product.perHour": "за годину",
        ...
        "f.searchListings": "Пошук оголошень",
        "f.searchExample": "Напр., генератор, дриль, намет",
        "f.type": "Тип",
        "f.distance": "Відстань",
        "f.km1": "До 1 км",
        "f.km3": "До 3 км",
